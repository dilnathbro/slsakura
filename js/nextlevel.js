(function(){
  ...
  // Gate the AI assistant without changing the existing chatbot implementation.
  const originalChat=window.toggleChatbot;if(typeof originalChat==='function'&&!originalChat.__memberGated){window.toggleChatbot=function(){if(!requireMember())return;return originalChat.apply(this,arguments);};window.toggleChatbot.__memberGated=true;}
